...
#define CONFIGURE_ARGS " '--prefix=/home/shohams/MuST/external/p3dfft/P3DFFT' '--enable-fftw' '--with-fftw=/home/shohams/MuST/external/fftw/FFTW' 'LIBS='"
...
#define PACKAGE_STRING "P3DFFT 2.7.4"
