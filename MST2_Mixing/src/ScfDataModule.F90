...
!
!!xDx!! RPM Parameters
   integer (kind=IntKind) :: MaxBasis, MaxIter, MaxHistory 
!!xDx!!
!
...
!  -------------------------------------------------------------------
   ...
   rstatus = getKeyValue(tbl_id,'RPMMaxBasis',MaxBasis)
   rstatus = getKeyValue(tbl_id,'RPMMaxIter',MaxIter)
   rstatus = getKeyValue(tbl_id,'RPMMaxHistory',MaxHistory)
...
!
!  ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
   subroutine inputRPMParam(MB, MI, MH)
!  ===================================================================
   implicit none
   integer (kind=IntKind), intent(out) :: MB, MI, MH
   MB = MaxBasis
   MI = MaxIter
   MH = MaxHistory
   end subroutine inputRPMParam
!  ===================================================================
!
!  *******************************************************************
!
...
!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!xDx!!
   function isRPMMixing() result(c)
!  ===================================================================
   implicit none
!
   logical :: c
!
   if ( mixing_type == 3 ) then
      c = .true.
   else
      c = .false.
   endif
!
   end function isRPMMixing
!  ===================================================================
!
!  *******************************************************************
!
