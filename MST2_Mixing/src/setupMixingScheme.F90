...
!
   use ScfDataModule, only : isSimpleMixing, isDGAMixing, isBroydenMixing, isRPMMixing
...
!
   use MixingModule, only : setSimpleMixing, setDGAMixing, setBroydenMixing, setRPMMixing
!
   implicit none
!
...
!           ----------------------------------------------------------
         else if (isRPMMixing()) then
!           ----------------------------------------------------------
            call setBroydenMixing(is,id,alpha_mix)
            call setSimpleMixing(is,id,alpha_mix)
            call setRPMMixing(is,id,alpha_mix)
!           ----------------------------------------------------------
         else
!           ----------------------------------------------------------
